 ...
 */
public class Tabs implements JView<String>, ChangeListener{
	...
	private class TabSelectionModel extends BeanDefault implements Reference<String> {
		...
		private final EditableProp<Integer> selectedTabIndex = editable("selectedTabIndex", 0);
		...
		public EditableProp<Integer> selectedTabIndex() {
	...
	@Override
	public Reference<String> getModel() {
		return model;
	}
