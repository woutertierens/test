...
public class ReferenceCounter {
	...
	public boolean removeReference(Object element) {
		...
		if (count == null) {
			throw new ObservableCollectionRuntimeException("Attempted to remove a reference to an element not present in the reference map: '" + element + "'");
		...
		//There is a current count, decrement
			...
			if (count <= 0) {
				throw new ObservableCollectionRuntimeException("Non-positive reference count for element '" + element + "'");
