...
import org.jpropeller.properties.bean.BeanProp;
 ...
 */
public class BeanPropDefault<T extends Bean> extends GenericBeanPropDefault<T> implements BeanProp<T> {
	 ...
	 */
	private BeanPropDefault(PropName<? extends Prop<T>, T> name, T value) {
		super(name, value);
		this.propName = name;
	}
