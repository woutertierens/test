...
public class DaemonThreadFactory implements ThreadFactory {
	...
	private final static DaemonThreadFactory DEFAULT_INSTANCE = new DaemonThreadFactory();
	...
	/**
	 * Get a single shared default instance of {@link DaemonThreadFactory}, with
	 * {@link Thread#NORM_PRIORITY}, delegating to {@link Executors#defaultThreadFactory()}
	 * @return
	 * 		Default shared factory
	 */
	public final static DaemonThreadFactory getSharedInstance() {
