 ...
 */
public class ColorEditor implements UpdatableView<Bean>, JView<Bean> {

	PropViewHelp<Bean, Color> help;

	Reference<? extends Bean> model;
	PropName<? extends EditableProp<Color>, Color> displayedName;
	...
	private ColorEditor(Reference<? extends Bean> model,
		...
		help = new PropViewHelp<Bean, Color>(this, displayedName, displayedName);
		help.connect();
	}
