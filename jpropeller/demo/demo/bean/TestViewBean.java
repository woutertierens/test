...
public class TestViewBean implements Bean {
	...
	Prop<TestViewBean> child = services.editable(TestViewBean.class, "child", null);
	 ...
	 * 		child property
	 */
	public Prop<TestViewBean> child() {return child;};
	...
	public final static void main(String[] args) {
		...
		GeneralUtils.enableConsoleLogging(ChangeablePropDefault.class);
