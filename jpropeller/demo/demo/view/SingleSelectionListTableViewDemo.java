	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				ListDeleteAction deleteAction = ListDeleteAction.create(reference);
				...
				BeanPathToEditable<ListSelectionEditableValueReference<LotsOfProps>, LotsOfProps> refToSelected = 
