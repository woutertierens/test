...
public class FriendList extends BeanDefault {
	...
	//Set up Props
	private Prop<String> title = editable("title", "default friend list title");
	private ListProp<Person> friends = editableList(Person.class, "friends");
	 ...
	 * 		friends property
	 */
	public ListProp<Person> friends() {return friends;};
