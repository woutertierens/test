...
public class Address extends BeanDefault {
	...
	//Set up Props
	private Prop<Integer> houseNumber = editable("houseNumber", 1);
	private Prop<String> street = editable("street", "default street value");
	 ...
	 */
	public Prop<Integer> houseNumber() {return houseNumber;};
