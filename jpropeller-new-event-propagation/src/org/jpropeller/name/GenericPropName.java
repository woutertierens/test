...
public class GenericPropName<P extends GeneralProp<T>, T> {
	 ...
	 */
	protected GenericPropName (String s, Class<?> clazz, boolean tGeneric, String propParametricTypes, PropInfo info) {
		this.s = s;
		this.clazz = clazz;
	...
	/**
	 * Make a {@link GenericPropName} for a {@link GenericEditableProp} containing
	 * an {@link ObservableList}
	 * NOTE: This is NOT a name for a {@link ListProp}, but for
	 * a normal {@link GenericEditableProp} that happens to contain
	 * an {@link ObservableList} - can be used for example in an
	 * {@link EditableReferenceToChangeable}, since {@link Reference}s
	 * always contain a {@link GenericProp}, NOT a {@link ListProp}
	 * @param <S>
	 * 		Type of value in the {@link ObservableList} in the {@link Prop}
	 * @param s
	 * 		String value of name
	 * @param clazz
	 * 		Class of value in the {@link ObservableList} in the {@link Prop}
	 * @return
	 * 		A new name
	 */
	public static <S> GenericPropName<GenericEditableProp<ObservableList<S>>, ObservableList<S>> editableObservableList(String s, Class<S> clazz) {
		String parametricTypes = "<" + clazz.getCanonicalName() + ">";
		return new GenericPropName<GenericEditableProp<ObservableList<S>>, ObservableList<S>>(s, ObservableList.class, true, parametricTypes, PropInfo.EDITABLE);
	}
	
	/**
	 * Make a {@link GenericPropName} for a {@link GenericEditableProp} containing
	 * an {@link ObservableMap}
	 * NOTE: This is NOT a name for a {@link MapProp}, but for
	 * a normal {@link GenericEditableProp} that happens to contain
	 * an {@link ObservableMap} - can be used for example in an
	 * {@link EditableReferenceToChangeable}, since {@link Reference}s
	 * always contain a {@link GenericProp}, NOT a {@link MapProp}
	 * @param <K>
	 *		Type of key in the {@link ObservableMap} in the {@link Prop}
	 * @param <S>
	 * 		Type of value in the {@link ObservableMap} in the {@link Prop}
	 * @param s
	 * 		String value of name
	 * @param clazz
	 * 		Class of value in the {@link ObservableMap} in the {@link Prop}
	 * @return
	 * 		A new name
	 */
	public static <K, S> GenericPropName<GenericEditableProp<ObservableMap<K, S>>, ObservableMap<K, S>> editableObservableMap(String s, Class<S> clazz) {
		String parametricTypes = "<" + clazz.getCanonicalName() + ">";
		return new GenericPropName<GenericEditableProp<ObservableMap<K, S>>, ObservableMap<K, S>>(s, ObservableMap.class, true, parametricTypes, PropInfo.EDITABLE);
	}
	
	/**
	 * Make a {@link GenericPropName} for a {@link GenericProp} containing
	 * an {@link ObservableList}
	 * NOTE: This is NOT a name for a {@link ListProp}, but for
	 * a normal {@link GenericEditableProp} that happens to contain
	 * an {@link ObservableList} - can be used for example in an
	 ...
	 * 		A new name
	 */
	public static <S> GenericPropName<GenericProp<ObservableList<S>>, ObservableList<S>> createObservableList(String s, Class<S> clazz) {
		String parametricTypes = "<" + clazz.getCanonicalName() + ">";
		return new GenericPropName<GenericProp<ObservableList<S>>, ObservableList<S>>(s, ObservableList.class, true, parametricTypes, PropInfo.DEFAULT);
	}
	 ...
	 * 		A new name
	 */
	public static <K, S> GenericPropName<GenericProp<ObservableMap<K, S>>, ObservableMap<K, S>> createObservableMap(String s, Class<S> clazz) {
		String parametricTypes = "<" + clazz.getCanonicalName() + ">";
		return new GenericPropName<GenericProp<ObservableMap<K, S>>, ObservableMap<K, S>>(s, ObservableMap.class, true, parametricTypes, PropInfo.DEFAULT);
	}
