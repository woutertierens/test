	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				final EditableReferenceToChangeable<ObservableList<LotsOfProps>> reference = EditableReferenceToChangeable.createObservableListReference(LotsOfProps.class, l);
