...
/**
 * A Bean is an object that potentially "has" {@link Prop}s
 * 
 ...
 * returns an {@link Prop})
 * 
 * person.address().get().street().get()
 * 		will return the street of the address of the person
 * 
 * NOTE: implementations must enforce the rules for {@link Bean}s, {@link BeanFeatures}s and {@link Prop}s:
 *		
