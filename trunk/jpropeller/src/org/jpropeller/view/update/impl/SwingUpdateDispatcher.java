...
public class SwingUpdateDispatcher implements UpdateDispatcher {
	...
	private Set<Updatable> pendingUpdatablesReceive = new IdentityHashSet<Updatable>(200);
	private Set<Updatable> pendingUpdatablesTransmit = new IdentityHashSet<Updatable>(200);
