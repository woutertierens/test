...
/**
 * Stores detail of a change to the mappings in a {@link Map}
 * @author shingoki
 *
 * @param <K>
 * 		The type of key in the map
 */
public interface MapChange<K> {
	 ...
	 * will return true, and the value of {@link MapChange#getKey()} may be used. If
	 ...
	 * key, it may not - that is, a {@link MapChange} may OVERspecify the change,
	 ...
	 * {@link CollectionChangeType#INSERTION} or {@link CollectionChangeType#DELETION} it
	 * may apply only to the mapping from a single key - in this case, this method
	 * will return the key in that mapping, and {@link MapChange#isKeyValid()} will
	 * return true.
