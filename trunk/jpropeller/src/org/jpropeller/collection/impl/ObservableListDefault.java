 ...
 */
public class ObservableListDefault<E> implements ObservableList<E> {
	...
	/**
	 * Create a new {@link ObservableListDefault} based on a given core
	 ...
	 * contents to implement {@link ObservableList}, for example 
	 * by propagating changes when the list is altered, etc.
	 * 
	 * NOTE: you must NOT modify the core {@link List} after using it
	 * to create an {@link ObservableListDefault}, otherwise you will stop the
	 * {@link ObservableListDefault} functioning as a compliant {@link ObservableList}.
	 ...
	 * @param core
	 * 
	 * 		This {@link ObservableListDefault} will delegate to a synchronized wrapper
