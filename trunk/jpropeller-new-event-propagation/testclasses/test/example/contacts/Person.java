 ...
 * @author shingoki
 */
public class Person extends BeanDefault {

	//Set up Props
	private EditableProp<String> name = editable("name", "default name");
	private EditableProp<Address> address = editable(Address.class, "address", new Address());
	 ...
	 * 		address
	 */
	public EditableProp<Address> address() {return address;};
	...
	public String toString() {
		String s = name().get() + " at " + address().get();
		return s;
	}
