...
public class Mirror extends BeanDefault {
	 ...
	 */
	public final static PropName<EditableProp<String>, String> S_NAME = PropName.editable("s", String.class);

	//Set up Props
	private EditableProp<String> s = editable("s", "default s value");
	private EditableProp<String> sMirror = editableFrom("sMirror", String.class, this).to(S_NAME);
	 ...
	 * 		s
	 */
	public EditableProp<String> s() {return s;};
	 ...
	 * 		sMirror property
	 */
	public EditableProp<String> sMirror() {return sMirror;};
